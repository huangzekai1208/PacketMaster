...
import { Activity, AlertTriangle, BarChart3, BookOpen, ChevronLeft, ChevronRight, Coins, FileSearch, FileUp, Menu, MessageSquare, Network, PanelLeft, PanelRight, Plus, RefreshCw, Send, Square, Trash2, X } from 'lucide-react'

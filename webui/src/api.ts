...
export interface ChatTurn { turn_id: string; analysis_id: string; question: string; answer: string; citations: Array<Record<string, unknown>>; limitations: string[]; suggestions: string[]; created_at: string }

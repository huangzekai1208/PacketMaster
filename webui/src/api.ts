...
export interface StallReport { mode: 'stall'; analysis_id: string; primary_cause: string; candidate_causes: Array<Record<string, unknown>>; key_evidence: Array<Record<string, unknown>>; confidence: number; coverage_summary: Record<string, unknown>; stall_events: Array<Record<string, unknown>>; protocol_summary: Record<string, unknown>; limitations: string[]; troubleshooting_steps: string[]; optimization_suggestions: string[]; analysis_metadata: Record<string, unknown> }
